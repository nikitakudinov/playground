...
import 'edite_tournament_model.dart';
export 'edite_tournament_model.dart';
...
class _EditeTournamentWidgetState extends State<EditeTournamentWidget> {
  ...
  void initState() {
    ...
    _model.nameController ??=
        TextEditingController(text: FFAppState().tournament.name);
    _model.tagController ??=
        TextEditingController(text: FFAppState().tournament.tag);
  }
                        ...
                        children: [
                          ...
                          wrapWithModel(
                            ...
                            child: CountryPickerWidget(
                              name: FFAppState().tournament.country,
                              flag: FFAppState().tournament.flag,
                            ),
                          ),
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
