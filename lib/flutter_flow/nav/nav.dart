...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : AuthorisationWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'AUTHORISATION',
          path: '/authorisation',
          builder: (context, params) => AuthorisationWidget(),
        ),
        FFRoute(
          name: 'REGISTRATION',
          path: '/registration',
        ...
        FFRoute(
          ...
          path: '/listTournament',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'LIST_TOURNAMENT')
              : ListTournamentWidget(),
        ),
        FFRoute(
          name: 'ADD_USERINFO',
          path: '/addUserinfo',
          builder: (context, params) => AddUserinfoWidget(),
        ),
        FFRoute(
          name: 'EDITE_TEAM',
          path: '/editeTeam',
