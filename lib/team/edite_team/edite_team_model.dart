...
class EditeTeamModel extends FlutterFlowModel<EditeTeamWidget> {
  ...
  ApiCallResponse? apiResult1dc1;
  // Stores action output result for [Custom Action - jsonToDataTypeTeamMember] action in EDITE_TEAM widget.
  List<TeamMemberStruct>? ccca;
